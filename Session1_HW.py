...
input_trees = []
tree = gh.DataTree("Get Integer 1")
tree.Append([{0}], ["5"])
input_trees.append(tree)

tree = gh.DataTree("Get Integer 2")
tree.Append([{0}], ["6"])
input_trees.append(tree)

output = gh.EvaluateDefinition('C:\\Users\\tuemi\\Downloads\\Folding object no plug ins.gh', input_trees)
